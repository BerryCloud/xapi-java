...
class XapiClientMultipartTests {
                            ...
                            .addAttachment(
                                a ->
                                    a.content("Simple attachment")
                                        ...
                                        .usageType(
                                            URI.create("http://adlnet.gov/expapi/attachments/text"))
                ...
                r.statement(
                    s ->
                        s.agentActor(a -> a.name("A N Other").mbox("mailto:another@example.com"))
                            .addAttachment(
                                a ->
                                    a.content(new byte[] {64, 65, 66, 67, 68, (byte) 255})
                                        .length(6)
                                        .contentType("application/octet-stream")
                                        .usageType(
                                            URI.create("http://adlnet.gov/expapi/attachments/code"))
                                    ...
                                    .addAttachment(
                                        a ->
                                            a.content("Simple attachment")
                                                ...
                                                .usageType(
                                                    URI.create(
                                                        "http://adlnet.gov/expapi/attachments/text"))
                                                .addDisplay(Locale.ENGLISH, "text attachment"))
                                    .build())))
        .block();
  ...
  void whenPostingStatementsWithTimestampAndAttachmentThenNoExceptionIsThrown()
    ...
    final var statement =
        Statement.builder()
            ...
            .addAttachment(
                a ->
                    a.content(new byte[] {64, 65, 66, 67, 68, 69})
                        .length(6)
                        .contentType("application/octet-stream")
  ...
  void whenGettingStatementWithAttachmentThenResponseIsExpected() {
    ...
    final var response =
        client
            .getStatement(r -> r.id("183aabbe-ef9e-49c9-82a3-16ce5135b25b").attachments(true))
            .block();
