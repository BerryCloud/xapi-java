...
class StatementTests {
  ...
  void whenSerializingStatementThenResultIsEqualToExpectedJson() throws IOException {
    ...
    System.out.println("two \n"
        + objectMapper.readTree(ResourceUtils.getFile("classpath:statement/statement.json")));



    // Then Result Is Equal To Expected Json
    assertThat(result,
        is(objectMapper.readTree(ResourceUtils.getFile("classpath:statement/statement.json"))));
