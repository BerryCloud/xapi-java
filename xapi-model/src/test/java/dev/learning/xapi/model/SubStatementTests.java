...
class SubStatementTests {
  ...
  void whenDeserializingSubStatementWithObjectOfTypeSubStatementThenExceptionIsThrown()
    ...
    final var file =
        ResourceUtils.getFile(
            "classpath:sub_statement/sub_statement_with_object_of_type_sub_statement.json");
  ...
  void whenDeserializingSubStatementWithObjectOfTypeActivityThenObjectIsInstanceOfActivity()
    ...
    final var file =
        ResourceUtils.getFile(
            "classpath:sub_statement/sub_statement_with_object_of_type_activity.json");
  ...
  @Test
  void
      whenDeserializingSubStatementWithObjectOfTypeAgentThenObjectIsInstanceOfAgentThenObjectIsInstanceOfAgent()
          throws IOException {

    final var file =
        ResourceUtils.getFile(
            "classpath:sub_statement/sub_statement_with_object_of_type_agent.json");
  ...
  void whenDeserializingSubStatementWithObjectOfTypeGroupThenObjectIsInstanceOfGroup()
    ...
    final var file =
        ResourceUtils.getFile(
            "classpath:sub_statement/sub_statement_with_object_of_type_group.json");
  ...
  @Test
  void
      whenDeserializingSubStatementWithObjectOfTypeStatementReferenceThenObjectIsInstanceOfStatementReference()
          throws IOException {
  ...
  void whenSerializingSubStatementThenResultIsEqualToExpectedJson() throws IOException {
    ...
    final var contextActivities =
        ContextActivities.builder()
            ...
            .other(Collections.singletonList(activity))
            .build();
    ...
    final var subStatement =
        SubStatement.builder()
            ...
            .verb(
                v ->
                    v.id(URI.create("http://example.com/confirmed"))
                        .addDisplay(Locale.US, "confirmed"))
            .object(statementRef)
  ...
  @Test
  void
      whenBuildingSubStatementWithAgentObjectWithoutObjectTypeThenSubStatementObjectObjectTypeIsNotNull() {
  ...
  @Test
  void
      whenBuildingSubStatementWithAgentObjectWithObjectTypeThenSubStatementObjectObjectTypeIsNotNull() {
